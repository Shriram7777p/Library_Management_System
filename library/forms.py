...
class BookForm(forms.ModelForm):
    class Meta:
        model=models.Book
        fields=['name','isbn','author','category', 'average_rating', 'isbn13' ,'Number_of_Pages', 'Ratings_Count', 'Text_Reviews_Count', 'Publication_Date', 'publisher', 'Language_Code', 'Book_ID']
